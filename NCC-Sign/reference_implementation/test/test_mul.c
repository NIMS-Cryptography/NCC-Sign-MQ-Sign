...
void test_orimul()
{
	...
	uint64_t cycles1, cycles2, cycles_orimul = 0, cycles_school = 0, cycles_toom = 0, cycles_AVX2 = 0;
	...
	for (i = 0; i < NTESTS; ++i)
	{
		...
		poly_mul_avx(&a, &b, &c);
		cycles2 = cpucycles();
		cycles_AVX2 = cycles_AVX2 + (cycles2 - cycles1);
	}
	printf("  AVX2 runs in ....................................... %10lld ", cycles_AVX2 / NTESTS);
	printf("\n");
}
